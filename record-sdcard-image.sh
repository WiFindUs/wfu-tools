...
echo -n "This WFU-Raspbian image was generated by $USER at " > image_generated.txt
date +"%c" >> image_generated.txt
rm -f wfu-raspbian.zip wfu-raspbian.zip.md5
zip -9 -j wfu-raspbian.zip "$WFU_TOOLS_DIR/README.md" wfu-raspbian.img image_generated.txt
rm -f wfu-raspbian.img image_generated.txt
md5sum wfu-raspbian.zip > wfu-raspbian.zip.md5
