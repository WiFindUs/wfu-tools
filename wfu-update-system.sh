...
echo "${STYLE_CYAN}Updating apt-get list...${STYLE_NONE}"
sudo apt-get -qq update > /dev/null 2>&1

echo "${STYLE_CYAN}Upgrading packages...${STYLE_NONE}"
sudo apt-get -qq upgrade > /dev/null 2>&1

echo "${STYLE_CYAN}Upgrading distro...${STYLE_NONE}"
sudo apt-get -qq dist-upgrade > /dev/null 2>&1

echo "${STYLE_CYAN}Installing apps...${STYLE_NONE}"
...
echo "${STYLE_CYAN}Cleaning up...${STYLE_NONE}"
