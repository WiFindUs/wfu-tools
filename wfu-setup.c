...
int write_rc_local(int num)
{
	...
	fprintf(file,"        sudo iw dev wlan0 set type ibss\n");
	fprintf(file,"        sudo iw dev wlan0 set channel 1\n");
	fprintf(file,"        sudo iw wlan0 connect wifindus_mesh keys 0:PWbDq39QQ8632\n");
